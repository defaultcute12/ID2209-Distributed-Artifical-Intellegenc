...
// -----------------------------------------------------------------------
   ...
   private JButton newBidder, newAuctioneer, move, clone, kill, quit;
...
// -------------------------------------------------------
      ...
      pane.add(newAuctioneer = new JButton("New Auctioneer"));
      newAuctioneer.setToolTipText("Create a new Artist Manager Agent");
      newAuctioneer.addActionListener(this);
      
      pane.add(newBidder = new JButton("New Bidder"));
      newBidder.setToolTipText("Create a new Curator Agent");
      newBidder.addActionListener(this);
...
// ---------------------------------------------
      ...
      if (ae.getSource() == newBidder)
      {
    	 System.out.println("New Bidder");
         GuiEvent ge = new GuiEvent(this, myAgent.NEW_BIDDER);
         myAgent.postGuiEvent(ge);
	  }
      else if (ae.getSource() == newAuctioneer)
      {
    	  System.out.println("New auctioneer");
          GuiEvent ge = new GuiEvent(this, myAgent.NEW_AUCTIONEER);
          myAgent.postGuiEvent(ge);
 	  }
